...
//   // mesh.update();  // Make sure we're not in an update loop
//   // mesh.setNodeTime(0); // Reset node time
//   // mesh.shutdown();  // Shut down the mesh network
...
//   // Optionally disconnect the WiFi AP (if it was started)
//   // WiFi.softAPdisconnect(true);
//   // WiFi.mode(WIFI_OFF);  // Optionally turn off the WiFi module
  
//   // Print a message to indicate that mesh is deinitialized
// }
